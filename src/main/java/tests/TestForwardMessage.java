...
public class TestForwardMessage {
    public static void main(String[] args){
        ...
        Link l = new Link(IPString.string_to_ip("127.0.0.3"),
                IPString.string_to_ip("225.225.225.0"),
                IPString.string_to_ip("127.0.0.3"),
                1);
        rt1.add(l);
        ...
        Link l2 = new Link(IPString.string_to_ip("127.0.0.3"),
                IPString.string_to_ip("225.225.225.0"),
                IPString.string_to_ip("127.0.0.2"),
                1);
        rt3.add(l2);
